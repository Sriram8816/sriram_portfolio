...
function sendEmail() {
    window.open('https://mail.google.com/mail/?view=cm&fs=1&to=example@gmail.com&su=Hello&body=Hi there!', '_blank');
}

document.querySelector(".work-button").addEventListener("click", function(e) {
    e.preventDefault();
